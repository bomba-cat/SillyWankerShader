...
// Perlin noise implementation for vec3 input (adapted from https://gist.github.com/patriciogonzalezvivo/670c22f3966e662d2f83)
...
vec3 randomColor() {
    ...
    color.g = clamp(noiseValG * 0.5 + 0.5, 0.0, 1.0); // Mapping noise value to the range [0, 1] for green channel
    color.b = clamp(noiseValB * 0.5 + 0.5, 0.0, 1.0); // Mapping noise value to the range [0, 1] for blue channel
